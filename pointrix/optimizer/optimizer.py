...
class OptimizerList:
    ...
    def state_dict(self) -> dict:
        ...
        state_dict = dict()
        for name, optimizer in self.optimizer_dict.items():
            state_dict[name] = optimizer.get_state_dict()
        return state_dict

    def load_state_dict(self, state_dict: dict, append=False) -> None:
        """
        ...
        for name, _state_dict in state_dict.items():
            ...
            self.optimizer_dict[name].load_state_dict(_state_dict, append)
